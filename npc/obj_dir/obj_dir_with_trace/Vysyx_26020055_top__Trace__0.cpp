...
void Vysyx_26020055_top___024root__trace_chg_0_sub_0(Vysyx_26020055_top___024root* vlSelf, VerilatedFst::Buffer* bufp);
...
void Vysyx_26020055_top___024root__trace_chg_0_sub_0(Vysyx_26020055_top___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgIData(oldp+56,(vlSelfRef.ysyx_26020055_top__DOT__WBU__DOT__u_RegisterFile__DOT__unnamedblk1__DOT__i),32);
    }
    bufp->chgBit(oldp+57,(vlSelfRef.clk));
    bufp->chgBit(oldp+58,(vlSelfRef.rst));
    bufp->chgIData(oldp+59,(vlSelfRef.pc),32);
    bufp->chgCData(oldp+60,(vlSelfRef.jmp_op),4);
    bufp->chgIData(oldp+61,(vlSelfRef.inst),32);
    bufp->chgCData(oldp+62,((0x0000001fU & (vlSelfRef.inst 
                                            >> 0x0000000fU))),5);
    bufp->chgCData(oldp+63,((0x0000001fU & (vlSelfRef.inst 
                                            >> 0x00000014U))),5);
    bufp->chgCData(oldp+64,((0x0000001fU & (vlSelfRef.inst 
                                            >> 7U))),5);
    bufp->chgBit(oldp+65,(((0x33U == (0x0000007fU & vlSelfRef.inst)) 
                           | ((0x3bU == (0x0000007fU 
                                         & vlSelfRef.inst)) 
                                 ...
                                 | ((IData)(vlSelfRef.ysyx_26020055_top__DOT__IDU__DOT____VdfgRegularize_h61fff987_0_2) 
                                    | ((0x6fU == (0x0000007fU 
                                       ...
                                       | (0x63U == 
                                          (0x0000007fU 
                                           & vlSelfRef.inst)))))))));
    bufp->chgBit(oldp+66,((3U == (0x0000007fU & vlSelfRef.inst))));
    bufp->chgBit(oldp+67,((0x23U == (0x0000007fU & vlSelfRef.inst))));
    bufp->chgCData(oldp+68,(((0x00100073U == vlSelfRef.inst)
                              ? 2U : 0U)),4);
    bufp->chgIData(oldp+69,(((2U == (IData)(vlSelfRef.jmp_op))
                              ? (0xfffffffeU & (vlSelfRef.ysyx_26020055_top__DOT__EXU__DOT__rs1_data 
                                                + vlSelfRef.ysyx_26020055_top__DOT__EXU__DOT__imm))
                              : 0U)),32);
    bufp->chgIData(oldp+70,(((2U == (IData)(vlSelfRef.jmp_op))
    ...
    bufp->chgBit(oldp+71,((2U == (IData)(vlSelfRef.jmp_op))));
    bufp->chgIData(oldp+72,(((2U == (IData)(vlSelfRef.jmp_op))
                              ? ((IData)(4U) + vlSelfRef.pc)
                              : 0U)),32);
    bufp->chgCData(oldp+73,((0x0000007fU & vlSelfRef.inst)),7);
    bufp->chgCData(oldp+74,((7U & (vlSelfRef.inst >> 0x0000000cU))),3);
    bufp->chgCData(oldp+75,((vlSelfRef.inst >> 0x00000019U)),7);
    bufp->chgIData(oldp+76,(((2U == (IData)(vlSelfRef.jmp_op))
                              ? ((2U == (IData)(vlSelfRef.jmp_op))
                                  ? (0xfffffffeU & 
                                     (vlSelfRef.ysyx_26020055_top__DOT__EXU__DOT__rs1_data 
                                      + vlSelfRef.ysyx_26020055_top__DOT__EXU__DOT__imm))
